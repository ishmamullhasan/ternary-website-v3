...
export default function GlobalDeliveryComp({ heading, description, lanes }: GlobalDeliveryCompProps) {
  ...
  return (
    ...
    // visible slice (70% of its box: ~390px at lg, ~460px at xl) — without a floor the card clips it.
    <section className="section-card relative lg:min-h-[440px] xl:min-h-[510px]">
