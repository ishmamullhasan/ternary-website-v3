...
export const ContactOffices: Block = {
  ...
  fields: [
    ...sectionHeader(),
    {
      ...
      fields: [
        { name: 'city', label: 'City', type: 'text', required: false, admin: { width: '50%' } },
        { name: 'tag', label: 'Tag', type: 'text', required: false, admin: { width: '50%' } },
        { name: 'timezone', label: 'Timezone', type: 'text', required: false, admin: { width: '50%' } },
        { name: 'hours', label: 'Hours', type: 'text', required: false, admin: { width: '50%' } },
