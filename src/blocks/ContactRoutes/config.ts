...
export const ContactRoutes: Block = {
  ...
  fields: [
    ...sectionHeader(),
    {
      ...
      fields: [
        { name: 'title', label: 'Title', type: 'text', required: false, admin: { width: '50%' } },
        { name: 'email', label: 'Email', type: 'text', required: false, admin: { width: '50%' } },
        { name: 'description', label: 'Description', type: 'textarea', required: false },
        { name: 'replyWindow', label: 'Reply Window', type: 'text', required: false, admin: { width: '50%' } },
        { name: 'cta', label: 'CTA Label', type: 'text', required: false, admin: { width: '50%' } },
        {
          name: 'info',
